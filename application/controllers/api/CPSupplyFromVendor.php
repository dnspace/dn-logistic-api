 ...
 * @since : Ock 2017
 */
class CPSupplyFromVendor extends REST_Controller
{
    //declare name of the table
    private $table_name = 'sfvendor';
    ...
    {
        parent::__construct();
        $this->load->model('supplyFromVendor/Trans_model','MTrans');
        $this->load->model('supplyFromVendor/Detail_model','MTrans_D');
        $this->load->model('supplyFromVendor/Tmp_model','MTrans_T');
...
/////////////////////////////////////////////////////////////////////
    ...
    function create_trans_post()
    {
        ...
        $dataInfo = array(
            ...
            $this->table_name.'_po_num'=>$fponum,
...
/////////////////////////////////////////////////////////////////////
    ...
    public function get_trans_detail_post(){
        ...
        if ($transnum != "") $arrWhere['sfvendor_num'] = $transnum;
