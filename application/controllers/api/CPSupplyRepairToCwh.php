 ...
 * @since : NOV 2018
 */
class CPSupplyRepairToCwh extends REST_Controller
{
    private $fields;
    private $db_index_key = 'repairdelivery_num';
    ...
    public function get_trans_detail_post(){
        ...
        if ($transnum != "") {
            $arrWhere[$this->db_index_key] = $transnum;
        }else{
            $arrWhere[$this->db_index_key] = "";
        }
    ...
    */
    ...
    public function update_detail_post(){
        ...
        if($fid != ''){
            ...
            if($qty != '')$arrWhere['dt_'.$this->db_table_name.'_qty']=$qty;
