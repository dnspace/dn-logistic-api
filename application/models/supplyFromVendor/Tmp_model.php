...
{
    var $tbl_t = 'sfvendor_tmp';
    var $view_t = 'viewsfvendor';
    var $primKey = 'tmp_sfvendor_id';
    var $indexKey = 'tmp_sfvendor_uniqid';
    var $indexKey2 = 'part_number';
    var $indexKey3 = 'serial_number';
    var $tempqty = 'tmp_sfvendor_qty';
    var $order = array('tmp_sfvendor_id' => 'desc'); // default order
