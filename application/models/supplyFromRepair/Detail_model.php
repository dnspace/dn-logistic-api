...
{
    var $tbl_d = 'sfrepair_detail';
    var $view_detail = 'viewdetailsfrepair';
    var $primKey = 'sfrepair_detail_id';
    var $indexKey = 'sfrepair_num';
    var $indexKey2 = 'part_number';
    var $indexKey3 = 'serial_number';
    var $order = array('sfrepair_num' => 'desc'); // default order
    ...
    {
        $this->db->trans_start();
        $this->db->insert($this->tbl_d, $dataInfo);
    ...
    {
        $this->db->where($this->indexKey, $id);
        $this->db->update($this->tbl_d, $dataInfo);
