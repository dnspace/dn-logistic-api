...
{
    var $tbl_engineers = 'engineers';
    var $view_engineers = 'viewengineers';
    var $primKey = 'engineer_id';
    var $indexKey = 'engineer_key';
    var $order = array('engineer_key' => 'asc'); // default order
    ...
    {
        $this->db->from($this->tbl_engineers);
    ...
    function get_viewdata($arrWhere = array(), $arrOrder = array(), $type = "AND"){
        ...
        $this->db->select('*');
        $this->db->from($this->view_engineers);
    ...
    {
        $this->db->trans_start();
        $this->db->insert($this->tbl_engineers, $dataInfo);
    ...
    {
        $this->db->where($this->indexKey, $id);
        $this->db->update($this->tbl_engineers, $dataInfo);
     ...
     */
     ...
     {
         $this->db->where($this->indexKey, $id);
         $this->db->delete($this->tbl_engineers);
