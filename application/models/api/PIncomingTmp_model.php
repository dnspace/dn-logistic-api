...
class PIncomingTmp_model extends CI_Model
{
    var $tbl_incoming_t = 'incomings_tmp';
    var $view_incoming = 'viewincomings';
    var $primKey = 'tmp_incoming_id';
    var $indexKey = 'tmp_incoming_uniqid';
    var $indexKey2 = 'part_number';
    var $indexKey3 = 'serial_number';
    var $order = array('tmp_incoming_id' => 'desc'); // default order
    ...
    function count_all()
    {
        $this->db->from($this->tbl_incoming_t);
	...
	function count_cart($arrWhere = array())
    {
        ...
        $this->db->select('SUM(tmp_incoming_qty) AS total');
        $this->db->from($this->tbl_incoming_t);
    ...
    {
        $this->db->trans_start();
        $this->db->insert($this->tbl_incoming_t, $dataInfo);
    ...
    function update_data($dataInfo, $id)
    {
        ...
        $this->db->update($this->tbl_incoming_t, $dataInfo);
     ...
     */
     ...
     {
         $this->db->where($this->primKey, $id);
         $this->db->delete($this->tbl_incoming_t);
