...
class PDeliveryNoteTmp_model extends CI_Model
{
    var $tbl_delivery_note_t = 'delivery_note_tmp';
    var $view_delivery_note = 'viewdeliverynote';
    var $primKey = 'tmp_delivery_note_id';
    var $indexKey = 'tmp_delivery_note_uniqid';
    var $indexKey2 = 'part_number';
    var $indexKey3 = 'serial_number';
    var $order = array('tmp_delivery_note_id' => 'desc'); // default order
    ...
    function count_all()
    {
        $this->db->from($this->tbl_delivery_note_t);
	...
	function count_cart($arrWhere = array())
    {
        ...
        $this->db->select('SUM(tmp_delivery_note_qty) AS total');
        $this->db->from($this->tbl_delivery_note_t);
    ...
    function get_viewdata($arrWhere = array(), $arrOrder = array(), $type = "AND"){
        ...
        $this->db->select('*');
        $this->db->from($this->view_delivery_note);
    ...
    {
        $this->db->trans_start();
        $this->db->insert($this->tbl_delivery_note_t, $dataInfo);
    ...
    function update_data($dataInfo, $id)
    {
        ...
        $this->db->update($this->tbl_delivery_note_t, $dataInfo);
     ...
     */
     ...
     {
         $this->db->where($this->primKey, $id);
         $this->db->delete($this->tbl_delivery_note_t);
