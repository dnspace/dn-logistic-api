...
{
    var $tbl_atm = 'atm_points';
    var $primKey = 'atmp_id';
    var $indexKey = 'atmp_ssbid';
    var $order = array('atmp_cust' => 'asc'); // default order
    ...
    {
        $this->db->trans_start();
        $this->db->insert($this->tbl_atm, $dataInfo);
	...
	/**
     * This function used to get data information by indexKey
     * @param number $indexKey : This is indexKey
     * @return array $result : This is data information
     */
    function get_data_info2($indexKey)
    {
        $this->db->select('*');
        $this->db->from($this->tbl_atm);
        $this->db->where($this->indexKey, $indexKey);
        $query = $this->db->get();
    ...
    {
        $this->db->where($this->primKey, $id);
        $this->db->update($this->tbl_atm, $dataInfo);
