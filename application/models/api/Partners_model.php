...
{
    var $tbl_partner = 'service_partners';
    var $view_partner = 'viewpartners';
    var $primKey = 'partner_id';
    var $indexKey = 'partner_uniqid';
    var $order = array('partner_name' => 'asc'); // default order
    ...
    function get_viewdata($arrWhere = array(), $arrOrder = array(), $type = "AND"){
        ...
        $this->db->select('*');
        $this->db->from($this->view_partner);
    ...
    {
        $this->db->trans_start();
        $this->db->insert($this->tbl_partner, $dataInfo);
    ...
    {
        $this->db->where($this->indexKey, $id);
        $this->db->update($this->tbl_partner, $dataInfo);
     ...
     */
     ...
     {
         $this->db->where($this->indexKey, $id);
         $this->db->delete($this->tbl_partner);
