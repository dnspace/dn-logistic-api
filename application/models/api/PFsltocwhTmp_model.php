...
class PFsltocwhTmp_model extends CI_Model
{
    var $tbl_t = 'fsltocwh_tmp';
    var $view_t = 'viewfsltocwh';
    var $primKey = 'tmp_fsltocwh_id';
    var $indexKey = 'tmp_fsltocwh_uniqid';
    var $indexKey2 = 'part_number';
    var $indexKey3 = 'serial_number';
    var $tempqty = 'tmp_fsltocwh_qty';
    var $order = array('tmp_fsltocwh_id' => 'desc'); // default order
